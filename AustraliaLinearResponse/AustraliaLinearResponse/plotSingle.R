...
plot(newCut$stdBestClass,newCut$SurvTimeMonths,pch=3-2*newCut$Status,col=2-newCut$Status,
	xaxt='n',yaxt='n',xlim=c(1,3),ylim=c(0,tmpYlim),
	xlab='Response Class',ylab='Survival (months)')
tmpCorr=with(newCut,rcorr.cens(stdBestClass,Surv(SurvTimeMonths,Status),outx=TRUE))
...
box()
lines(x=c(2.3,2.3),y=c(-2,3.5),col='red')
arrows(2.3,3.5,2.7,3.5,col='red',length=0.15)
text(x=2.4,y=9,labels='-30%',col='red')
lines(x=c(1.7,1.7),y=c(-2,3.5),col='red')
arrows(1.7,3.5,1.3,3.5,col='red',length=0.15)
text(x=1.6,y=9,labels='+20%',col='red')

#optimized (best) RECIST, C plot
plot(newCut$bestClass,newCut$SurvTimeMonths,pch=3-2*newCut$Status,col=2-newCut$Status,
	xaxt='n',yaxt='n',xlim=c(1,3),ylim=c(0,tmpYlim),
	xlab='Response Class',ylab='Survival (months)')
tmpCorr=with(newCut,rcorr.cens(bestClass,Surv(SurvTimeMonths,Status),outx=TRUE))
axis(1,at=1:3,label=c('PD','SD','PR'))
axis(2,at=seq(0,tmpYlim,12))
...
lines(x=c(2.3,2.3),y=c(-2,3.5),col='red')
arrows(2.3,3.5,2.7,3.5,col='red',length=0.15)
text(x=2.4,y=9,labels=bquote(paste(.(100*tmp.new.PR),'%')),col='red')
lines(x=c(1.7,1.7),y=c(-2,3.5),col='red')
arrows(1.7,3.5,1.3,3.5,col='red',length=0.15)
text(x=1.6,y=9,labels=bquote(paste('+',.(100*tmp.new.PD),'%')),col='red')

# cross-validated optimized (best) RECIST, C plot
plot(cv.Class$bestCuts.bestClass,cv.Class$SurvTimeMonths,pch=3-2*cv.Class$Status,col=2-cv.Class$Status,
	xaxt='n',yaxt='n',xlim=c(1,3),ylim=c(0,tmpYlim),
	xlab='Response Class',ylab='Survival (months)')
...
survplot(survfit(Surv(SurvTimeMonths,Status)~stdBestClass,data=newCut),
	xlab='Overall Survival from Diagnosis [Months]',xlim=c(0,tmpXlim),time.inc=12,
	conf='none',label.curves=list(keys='lines',labels=c('PD','SD','PR')),
	lty=c('dotted','dashed','solid'),lwd=1)
tmpLR=survdiff(Surv(SurvTimeMonths,Status)~stdBestClass,data=newCut)
...
tmpLR=survdiff(Surv(SurvTimeMonths,Status)~bestClass,data=newCut)
tmpLRdf=length(tmpLR$obs)-1
tmpLRcs=tmpLR$chisq
tmpLRp=pchisq(tmpLRcs,tmpLRdf,lower.tail=FALSE)
...
survplot(survfit(Surv(SurvTimeMonths,Status)~bestCuts.bestClass,data=cv.Class),
	xlab='Overall Survival from Diagnosis [Months]',xlim=c(0,tmpXlim),time.inc=12,
	conf='none',label.curves=list(keys='lines',labels=c('PD','SD','PR')),
	lty=c('dotted','dashed','solid'),lwd=1)
tmpLR=survdiff(Surv(SurvTimeMonths,Status)~bestCuts.bestClass,data=cv.Class)
tmpLRdf=length(tmpLR$obs)-1
tmpLRcs=tmpLR$chisq
tmpLRp=pchisq(tmpLRcs,tmpLRdf,lower.tail=FALSE)
...
plot(newCut$stdFirstClass,newCut$SurvTimeMonths,pch=3-2*newCut$Status,col=2-newCut$Status,
	xaxt='n',yaxt='n',xlim=c(1,3),ylim=c(0,tmpYlim),
	xlab='Response Class',ylab='Survival (months)')
tmpCorr=with(newCut,rcorr.cens(stdFirstClass,Surv(SurvTimeMonths,Status),outx=TRUE))
axis(1,at=1:3,label=c('PD','SD','PR'))
axis(2,at=seq(0,tmpYlim,12))
...
plot(newCut$firstClass,newCut$SurvTimeMonths,pch=3-2*newCut$Status,col=2-newCut$Status,
	xaxt='n',yaxt='n',xlim=c(1,3),ylim=c(0,tmpYlim),
	xlab='Response Class',ylab='Survival (months)')
tmpCorr=with(newCut,rcorr.cens(firstClass,Surv(SurvTimeMonths,Status),outx=TRUE))
axis(1,at=1:3,label=c('PD','SD','PR'))
axis(2,at=seq(0,tmpYlim,12))
...
plot(cv.Class$bestCuts.firstClass,cv.Class$SurvTimeMonths,pch=3-2*cv.Class$Status,col=2-cv.Class$Status,
	xaxt='n',yaxt='n',xlim=c(1,3),ylim=c(0,tmpYlim),
	xlab='Response Class',ylab='Survival (months)')
...
survplot(survfit(Surv(SurvTimeMonths,Status)~stdFirstClass,data=newCut),
	xlab='Overall Survival from Diagnosis [Months]',xlim=c(0,tmpXlim),time.inc=12,
	conf='none',label.curves=list(keys='lines',labels=c('PD','SD','PR')),
	lty=c('dotted','dashed','solid'),lwd=1)
tmpLR=survdiff(Surv(SurvTimeMonths,Status)~stdFirstClass,data=newCut)
tmpLRdf=length(tmpLR$obs)-1
tmpLRcs=tmpLR$chisq
tmpLRp=pchisq(tmpLRcs,tmpLRdf,lower.tail=FALSE)
...
survplot(survfit(Surv(SurvTimeMonths,Status)~firstClass,data=newCut),
	xlab='Overall Survival from Diagnosis [Months]',xlim=c(0,tmpXlim),time.inc=12,
	conf='none',label.curves=list(keys='lines',labels=c('SD','PR')),
	lty=c('dashed','solid'),lwd=1)
tmpLR=survdiff(Surv(SurvTimeMonths,Status)~firstClass,data=newCut)
tmpLRdf=length(tmpLR$obs)-1
tmpLRcs=tmpLR$chisq
tmpLRp=pchisq(tmpLRcs,tmpLRdf,lower.tail=FALSE)
...
survplot(survfit(Surv(SurvTimeMonths,Status)~bestCuts.firstClass,data=cv.Class),
	xlab='Overall Survival from Diagnosis [Months]',xlim=c(0,tmpXlim),time.inc=12,
	conf='none',label.curves=list(keys='lines',labels=c('PD','SD','PR')),
	lty=c('dotted','dashed','solid'),lwd=1)
tmpLR=survdiff(Surv(SurvTimeMonths,Status)~bestCuts.firstClass,data=cv.Class)
tmpLRdf=length(tmpLR$obs)-1
tmpLRcs=tmpLR$chisq
tmpLRp=pchisq(tmpLRcs,tmpLRdf,lower.tail=FALSE)
